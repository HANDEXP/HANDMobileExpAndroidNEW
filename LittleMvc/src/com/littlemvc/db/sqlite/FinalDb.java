 ...
 */
package com.littlemvc.db.sqlite;
...
import com.littlemvc.db.sqlite.CursorUtils;
import com.littlemvc.db.sqlite.DbModel;
import com.littlemvc.db.sqlite.ManyToOneLazyLoader;
import com.littlemvc.db.sqlite.OneToManyLazyLoader;
import com.littlemvc.db.sqlite.SqlBuilder;
import com.littlemvc.db.sqlite.SqlInfo;
import com.littlemvc.db.table.KeyValue;
import com.littlemvc.db.table.ManyToOne;
...
public class FinalDb {
	...
	public <T> List<T> findByColumNameWithWhere(Class<T> clazz, String strWhere,String orderBy  ){
		checkTableExist(clazz);
		return findAllBySql(clazz, SqlBuilder.getSelectSqlByColumnName(clazz)
